...
import github.vrih.xsub.util.SilentServiceTask;
...
public class RemoteControlClientLP extends RemoteControlClientBase {
	...
	private static final String CUSTOM_ACTION_THUMBS_UP = "github.vrih.xsub.THUMBS_UP";
	private static final String CUSTOM_ACTION_THUMBS_DOWN = "github.vrih.xsub.THUMBS_DOWN";
	private static final String CUSTOM_ACTION_STAR = "github.vrih.xsub.STAR";
