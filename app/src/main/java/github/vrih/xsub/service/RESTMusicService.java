...
import github.vrih.xsub.service.parser.InternetRadioStationParser;
import github.vrih.xsub.service.parser.JukeboxStatusParser;
import github.vrih.xsub.service.parser.LicenseParser;
import github.vrih.xsub.service.parser.LyricsParser;
import github.vrih.xsub.service.parser.MusicDirectoryParser;
import github.vrih.xsub.service.parser.MusicFoldersParser;
import github.vrih.xsub.service.parser.PlayQueueParser;
import github.vrih.xsub.service.parser.PlaylistParser;
import github.vrih.xsub.service.parser.PlaylistsParser;
import github.vrih.xsub.service.parser.PodcastChannelParser;
import github.vrih.xsub.service.parser.PodcastEntryParser;
import github.vrih.xsub.service.parser.RandomSongsParser;
import github.vrih.xsub.service.parser.ScanStatusParser;
import github.vrih.xsub.service.parser.SearchResult2Parser;
import github.vrih.xsub.service.parser.SearchResultParser;
import github.vrih.xsub.service.parser.ShareParser;
import github.vrih.xsub.service.parser.StarredListParser;
...
public class RESTMusicService implements MusicService {
    ...
    public List<MusicFolder> getMusicFolders(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new MusicFoldersParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
	...
	private MusicDirectory getMusicDirectoryImpl(String id, String name, boolean refresh, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new MusicDirectoryParser(context, getInstance(context)).parse(name, reader);
		} finally {
			Util.close(reader);
		}
	}
    ...
    private SearchResult searchOld(SearchCritera critera, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new SearchResultParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    private SearchResult searchNew(SearchCritera critera, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new SearchResult2Parser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    public MusicDirectory getPlaylist(boolean refresh, String id, String name, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
			return new PlaylistParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    public List<Playlist> getPlaylists(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new PlaylistsParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    public Lyrics getLyrics(String artist, String title, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new LyricsParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    public MusicDirectory getAlbumList(String type, int size, int offset, boolean refresh, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new EntryListParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
	...
	public MusicDirectory getAlbumList(String type, String extra, int size, int offset, boolean refresh, Context context, ProgressListener progressListener) throws Exception {
		...
		Reader reader = getReader(context, progressListener, method, names, values, true);
		try {
			return new EntryListParser(context, instance).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public MusicDirectory getRandomSongs(int size, String artistId, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new RandomSongsParser(context, instance).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
    ...
    public MusicDirectory getStarredList(Context context, ProgressListener progressListener) throws Exception {
        ...
        Reader reader = getReader(context, progressListener, method, names, values, true);
        try {
            return new StarredListParser(context, instance).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
    ...
    public MusicDirectory getRandomSongs(int size, String musicFolderId, String genre, String startYear, String endYear, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new RandomSongsParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
    }
	...
	public List<Share> getShares(Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new ShareParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public List<Genre> getGenres(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new GenreParser(context, getInstance(context)).parse(reader);
        } finally {
            Util.close(reader);
        }
	}
	...
	public List<PodcastChannel> getPodcastChannels(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            List<PodcastChannel> channels = new PodcastChannelParser(context, getInstance(context)).parse(reader);
	...
	public MusicDirectory getPodcastEpisodes(boolean refresh, String id, Context context, ProgressListener progressListener) throws Exception {
        ...
        try {
            return new PodcastEntryParser(context, getInstance(context)).parse(id, reader);
        } finally {
            Util.close(reader);
        }
	}
	...
	public MusicDirectory getNewestPodcastEpisodes(boolean refresh, Context context, ProgressListener progressListener, int count) throws Exception {
		...
		try {
			return new PodcastEntryParser(context, getInstance(context)).parse(null, reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public MusicDirectory getBookmarks(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new BookmarkParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public User getUser(boolean refresh, String username, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			List<User> users = new UserParser(context, getInstance(context)).parse(reader);
			if(users.size() > 0) {
	...
	public List<User> getUsers(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new UserParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public ArtistInfo getArtistInfo(String id, boolean refresh, boolean allowNetwork, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new ArtistInfoParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public MusicDirectory getVideos(boolean refresh, Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new VideosParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	public PlayerQueue getPlayQueue(Context context, ProgressListener progressListener) throws Exception {
		...
		try {
			return new PlayQueueParser(context, getInstance(context)).parse(reader);
		} finally {
			Util.close(reader);
		}
	}
	...
	private int processOfflineScrobbles(final Context context, final ProgressListener progressListener) {
